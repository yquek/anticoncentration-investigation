"""Plot exact 3x3x3 collision probability and final-time histogram."""
...
with open("results_3x3x3_t20.json") as f:
    data = json.load(f)
...
fig.suptitle(
    rf"Anticoncentration of $\mathcal{{E}}(k\!=\!{k})$ on a 3-D cubic lattice (OBC)",
    fontsize=15, y=1.01)
plt.tight_layout()

out = "anticoncentration_3x3x3_t20.png"
